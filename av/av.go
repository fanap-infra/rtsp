...
var (
	...
	// daneshvar.ho
	ONVIF_METADATA = MakeMetadataCodecType(avCodecTypeMagic + 6)
)

const codecTypeVideoBit = 0x00
const codecTypeAudioBit = 0x01
const codecTypeMetadataBit = 0x02
const codecTypeOtherBits = 2
...
func (self CodecType) String() string {
	...
	case NELLYMOSER:
		return "NELLYMOSER"
	case ONVIF_METADATA: // daneshvar.ho
...
func (self CodecType) IsAudio() bool {
	return self&codecTypeAudioBit == codecTypeAudioBit
}

func (self CodecType) IsVideo() bool {
	return self&codecTypeVideoBit == codecTypeVideoBit
}

func (self CodecType) IsMetadata() bool {
	return self&codecTypeMetadataBit == codecTypeMetadataBit
}
...
func MakeVideoCodecType(base uint32) (c CodecType) {
	c = CodecType(base)<<codecTypeOtherBits | CodecType(codecTypeVideoBit)
	return
}

// daneshvar.ho
// Make a new onvif metadata codec type.
func MakeMetadataCodecType(base uint32) (c CodecType) {
	c = CodecType(base)<<codecTypeOtherBits | CodecType(codecTypeMetadataBit)
	return
}
